        ...
        void _upgrade_hand(){
            switch(hand_type){
                ...
                case HandType::FullHouse:
                    if(_joker_count >= 2) hand_type = HandType::FiveOfAKind;
                    else if(_joker_count == 1) hand_type = HandType::FourOfAKind;
                    break;
                case HandType::ThreeOfAKind:
                    hand_type = HandType::FourOfAKind;
                    break;
                case HandType::TwoPair:
                    if(_joker_count == 2) hand_type = HandType::FourOfAKind;
                    else if(_joker_count == 1) hand_type = HandType::FullHouse;
                    break;
                ...
                case HandType::HighCard:
                    ...
                    break;
                default:
                    cerr << "Did not recognize HandType " << static_cast<int>(hand_type) << endl;
                    exit(EXIT_FAILURE);
            }
        }
};
